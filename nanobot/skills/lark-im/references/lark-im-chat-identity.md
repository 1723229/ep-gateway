...
- **Owner-only actions such as owner transfer:** require the actual owner to complete UAT authorization through the `lark-shared` unified auth entry, then perform the action as that owner.
